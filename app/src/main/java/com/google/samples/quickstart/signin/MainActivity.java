...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onConnected(Bundle bundle) {
       ...
       // Log.d(TAG, "Tokenid:" + sAccessToken);
    ...
    private class GetIdTokenTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
           ...
           String scope =  "audience:server:client_id:" + "372355961536-g2pftp7d2pk50125c8vj6caiibghtrmr.apps.googleusercontent.com";

           // String scope="oauth2:server:client_id:22114338477-c8mda46eg1mekcgmash0irp6s0v06j64.apps.googleusercontent.com:api_scope:https://www.googleapis.com/auth/plus.login";
            //String scopes = "audience:server:client_id:" + SERVER_CLIENT_ID; // Not the app's client ID.
            try {
                 sAccessToken= GoogleAuthUtil.getToken(getApplicationContext(),account , scope);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                // ...
                Log.d(TAG, "Tokenid:" + result);
                new connectRestApi().execute(result);
            } else {
    ...
    private class connectRestApi extends AsyncTask <String, Void, String> {

        protected String doInBackground(String... tokenid) {

            try {
                return downloadUrl("http://192.168.48.143:8080/cluborg.backend/rest/todo",tokenid[0]);
            } catch (IOException e) {
